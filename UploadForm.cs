...
namespace uploader
{
    public partial class UploadForm : DarkForm
    {
        ...
        public UploadForm(drag drag, Settings settings, bool reopen, string fileName)
        {
            _fileName = fileName;
            _drag = drag;
            _settings = settings;
        ...
        private void UploadForm_Load(object sender, EventArgs e)
        {
            ...
            sha2Textbox.Text = _fileName.ToString();
        ...
        private void settingsGroup_Enter(object sender, EventArgs e)
        {

        }

        private void shaTextbox_TextChanged(object sender, EventArgs e)
        {
